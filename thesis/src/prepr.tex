...
\section{Preparazione dell'Ambiente di Lavoro}
	...
	\subsection{Ottenere gli strumenti necessari}
		...
		Per ottenere \textit{pymongo}, invece, occorre utilizzare il \textit{package manager} di Python, \texttt{pip}, invocandolo semplicemente come segue:
