...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Analisi di dati relativi a studenti e insegnamenti del  Corso di Laurea in Informatica tramite tecniche di data mining\xspace}
\newcommand{\myEnglishTitle}{Analysis of data concerning students and courses of the Computer Science Degree Course through data mining techniques\xspace}
% a me 'sti titoli sembrano troppo lunghi
